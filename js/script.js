...
(function () {
    ...
    $(function () {
        ...
        if (plugins.rdGoogleMaps.length) {
            $.getScript("//maps.google.com/maps/api/js?key=AIzaSyBrTdYaApdd3K0ZgdEs4sCAiRbSoErhJoU&sensor=false&libraries=geometry,places&v=3.7", function () {
...
var myfunc = setInterval(function () {
    ...
    if (timeleft < 0) {
        ...
        document.getElementById("mins").innerHTML = "E"
        document.getElementById("secs").innerHTML = "R"
    }
}, 1000);